            ...
            <Table className="min-w-full">
              <TableHeader className="sticky top-0 z-10 bg-muted">
                <TableRow>
                  ...
                  <TableHead scope="col" rowSpan={2} className="sticky left-[119px] z-30 w-[180px] text-left bg-muted">Store Name</TableHead>
                ...
                {reportData.map((row) => {
                    ...
                    return (
                        <TableRow key={row.storeCode} className="hover:bg-muted/30">
                            <TableCell className="font-medium sticky left-0 z-20 bg-card">{row.storeCode}</TableCell>
                            <TableCell className="sticky left-[119px] z-20 bg-card">{row.storeName}</TableCell>
                            {/* Overview Data */}
